...
class Ui_consumer_home(object):
    def setupUi(self, consumer_home):
        ...
        self.guest.setGeometry(QtCore.QRect(0, 0, 551, 421))
        ...
        self.tabWidget_2.setGeometry(QtCore.QRect(0, 0, 551, 411))
        ...
        self.numCardLabel = QtGui.QLabel(self.formLayoutWidget_3)
        self.numCardLabel.setObjectName(_fromUtf8("numCardLabel"))
        self.formLayout_3.setWidget(0, QtGui.QFormLayout.LabelRole, self.numCardLabel)
        self.input_numCarte = QtGui.QLineEdit(self.formLayoutWidget_3)
        self.input_numCarte.setObjectName(_fromUtf8("input_numCarte"))
        self.formLayout_3.setWidget(0, QtGui.QFormLayout.FieldRole, self.input_numCarte)
        self.expirationDateLabel = QtGui.QLabel(self.formLayoutWidget_3)
        self.expirationDateLabel.setObjectName(_fromUtf8("expirationDateLabel"))
        self.formLayout_3.setWidget(1, QtGui.QFormLayout.LabelRole, self.expirationDateLabel)
        self.input_dateExpiration = QtGui.QDateEdit(self.formLayoutWidget_3)
        self.input_dateExpiration.setObjectName(_fromUtf8("input_dateExpiration"))
        self.formLayout_3.setWidget(1, QtGui.QFormLayout.FieldRole, self.input_dateExpiration)
        self.cryptogrammeVisuelLabel_2 = QtGui.QLabel(self.formLayoutWidget_3)
        self.cryptogrammeVisuelLabel_2.setObjectName(_fromUtf8("cryptogrammeVisuelLabel_2"))
        self.formLayout_3.setWidget(2, QtGui.QFormLayout.LabelRole, self.cryptogrammeVisuelLabel_2)
        self.input_cryptogrammeVisuel = QtGui.QLineEdit(self.formLayoutWidget_3)
        self.input_cryptogrammeVisuel.setObjectName(_fromUtf8("input_cryptogrammeVisuel"))
        self.formLayout_3.setWidget(2, QtGui.QFormLayout.FieldRole, self.input_cryptogrammeVisuel)
        self.label_10 = QtGui.QLabel(self.tab_3)
        self.label_10.setGeometry(QtCore.QRect(40, 90, 301, 21))
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(30, 50, 491, 113))
        ...
        self.label_6.setGeometry(QtCore.QRect(30, 170, 151, 21))
        self.label_6.setObjectName(_fromUtf8("label_6"))
        self.formLayoutWidget_2 = QtGui.QWidget(self.tab_5)
        self.formLayoutWidget_2.setGeometry(QtCore.QRect(180, 170, 341, 113))
        ...
        self.check_packGaranti.setGeometry(QtCore.QRect(30, 290, 131, 21))
        self.check_packGaranti.setObjectName(_fromUtf8("check_packGaranti"))
        self.pushButton = QtGui.QPushButton(self.tab_5)
        self.pushButton.setGeometry(QtCore.QRect(430, 320, 92, 27))
...
"Nous avons détecté votre véhicule, vous pouvez vous garer. ", None))
        self.numCardLabel.setText(_translate("consumer_home", "Numéro de carte", None))
        self.expirationDateLabel.setText(_translate("consumer_home", "Date d\'expiration", None))
        self.cryptogrammeVisuelLabel_2.setText(_translate("consumer_home", "Cryptogramme visuel", None))
        self.label_10.setText(_translate("consumer_home", "Veuillez entrer vos coordonnées banquaires: ", None))
